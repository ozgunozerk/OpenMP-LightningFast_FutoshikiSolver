...
{   // pruning the matrix
    ...
    {
        /*
        std::cout << "Focus cell: " << row << " " << col << std::endl;
        ...
        */
        ...
        unprocessedCell--;
        /*
        std::cout << "After pruning with: " << row << " " << col << std::endl;
        std::cout << "Unprocessed cells: " << unprocessedCell << std::endl;
...
#pragma omp parallel
    ...
    std::cout << "***************" << std::endl << "THREAD NUM: " << limit << std::endl << std::endl;
